...
## Philosophy
Standard methodological and statistical training within these disciplines is misaligned with the *need* of student practitioners -- what is needed is a work process that minimizes error via documentation and adherence to reproducibility standards.
:::
:::
