...
Immediate feedback for the effect of formatting on text in these [markdown editors](https://www.xda-developers.com/markdown-based-writing-tools-that-beat-traditional-word-processors/). You should be able to get a sense of *how text is treated* by exploring --  the general structure of markdown is portable across platforms, so it is helpful to know, although regional dialects will exhibit slight discrepancies (for example, `rMarkdown` shares many elements but minor peculiarities arise).
